/**
 * Class Light is created with two parameters called period and green period is
 * the time interval for the trafic light, and green is the length of the green
 * time.
 */
...
public class Light {
	 ...
	 * 
	 * @param period
	 *            Time interval for the Light
	 * @param green
	 *            checks if green light, cars or bikes and only pass if the
	 *            light is green
